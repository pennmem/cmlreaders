...
rhino_paths = {
    ...
    'area': ['data10/RAM/subjects/{subject_localization}/tal/leads.txt'],
    'good_leads': ['data10/RAM/subjects/{subject_localization}/tal/good_leads.txt'],
    ...
    # Report Data
    'session_summary': ['scratch/report_database/{subject}_{experiment}_{session}_session_summary.h5'],
    'classifier_summary': ['scratch/report_database/{subject}_{experiment}_{session}_classifier_session_{session}.h5'],
    'math_summary': ['scratch/report_database/{subject}_{experiment}_{session}_math_summary.h5'],
    'target_selection_table': ['{subject}_{experiment}_*_target_selection_table.csv'],
    'trained_classifier': ['scratch/report_database/{subject}_retrained_classifier.zip',
                           'scratch/report_database/{subject}_{experiment}_all_retrained_classifier.zip'],
    # Ramulator-related information
    'experiment_log': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/experiment.log'],
    'session_log': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/session.log'],
    'ramulator_session_folder': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/host_pc/*'],
    ## There can be multiple timestamped folders for the host pc files for when a session is restarted
    'event_log': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/host_pc/{timestamped_dir}/event_log.json'],
    'experiment_config': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/host_pc/{timestamped_dir}/experiment_config.json'],
    'raw_eeg': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/host_pc/{timestamped_dir}/eeg_timeseries.h5'],
    'odin_config': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/host_pc/{timestamped_dir}/config_files/{subject}_*.csv'],
    ## There can be multiple classifiers if artifcat detection was enabled and the classifier needed to be retrained. The order is important here
    ## In general, the files should be listed in order of preference so that the first file found is returned
    'used_classifier': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/host_pc/{timestamped_dir}/config_files/retrained_classifier/{subject}-classifier.zip',
    ...
    'excluded_pairs': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/host_pc/{timestamped_dir}/config_files/retrained_classifier/excluded_pairs.json',
    ...
    'all_pairs': ['data10/RAM/subjects/{subject}/behavioral/{experiment}/session_{session}/host_pc/{timestamped_dir}/config_files/pairs.json',
